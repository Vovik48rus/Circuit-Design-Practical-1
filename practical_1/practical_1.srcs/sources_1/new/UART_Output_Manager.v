...
(
	RESULT_SIZE = 64, // Количество разрядов входного числа, представленного в 16-й СС 
	...
	case(state) 
		...
		SEND_DATA: // Отправка строки на вывод по одному символу (байту, октету)
			begin
				...
				package_out <= result_char_array[ASCII_SIZE * (RESULT_CHAR_ARRAY_SIZE - char_counter) - 1 -: ASCII_SIZE]; // на выход подаём очередной пакет
